...
private:
    ...
    void createGraphicsPipeline() {
        vk::raii::ShaderModule shaderModule = createShaderModule(
            readFile("shaders/slang/018_shader_vertexbuffer.spv"));
    ...
    void createVertexBuffer() {
        ...
        stagingInfo.setSize(sizeof(vertices[0]) * vertices.size())
        ...
        memoryAllocateInfoStaging.setAllocationSize(memRequirementsStaging.size)
            .setMemoryTypeIndex(
