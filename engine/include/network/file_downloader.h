...
public:
     ...
     * @return 下载响应信息
     */
    static DownloadResponse DownloadToMemory(const std::string &url,
     ...
     * @return 下载响应信息
     */
    static DownloadResponse DownloadToFile(const std::string &url,
                                           const std::string &filepath,
                                           const DownloadOptions &options);
     ...
     */
    static std::optional<std::string> DownloadText(const std::string &url);
     ...
     * @return 下载响应信息
     */
    static DownloadResponse DownloadText(const std::string &url,
                                         const DownloadOptions &options);
     ...
     * @return 下载响应信息
     */
    static DownloadResponse PostJson(const std::string &url,
     ...
     */
    static std::future<DownloadResponse>
    DownloadToFileAsync(const std::string &url, const std::string &filepath,
                        const DownloadOptions &options = {});
     ...
     * @note 回调函数会在后台线程中执行
     */
    static void DownloadToMemoryAsync(const std::string &url,
     ...
     * @note 回调函数会在后台线程中执行
     */
    static void DownloadToFileAsync(const std::string &url,
                                    const std::string &filepath,
                                    const CompletionCallback &callback,
                                    const DownloadOptions &options = {});
