...
namespace vulkan {
    ...
    public:
        ...
        // Non-const Function
        void Create(const char *filepath, VkExtent2D extentInTiles,
                    VkFormat format_initial, VkFormat format_final,
                    bool generateMipmap = true) {
            ...
            if (pImageData) {
                if (fullExtent.width % extentInTiles.width ||
                    ...
                    std::println(
                        ...
                        "height should be in multiples of {}\n",
                        filepath, extentInTiles.width,
                        extentInTiles.height); // fallthrough
                } else {
        ...
        void Create(const uint8_t *pImageData, VkExtent2D fullExtent,
            ...
            if (fullExtent.width % extentInTiles.width ||
                ...
                std::println(
                    "[ texture2dArray ] ERROR\nImage not available!\nImage "
                    "width should be in multiples of {}\nImage height should "
                    "be in multiples of {}\n",
            ...
            // Data rearrangement can also be peformed by using tiled regions in
        ...
        void Create(arrayRef<const char *const> filepaths,
            ...
            formatInfo formatInfo = FormatInfo(format_initial);
            std::unique_ptr psImageData =
                std::make_unique<std::unique_ptr<uint8_t[]>[]>(
                    filepaths.Count());
    ...
    public:
        ...
        static bool FormatAvailability(VkFormat format,
            ...
            return FormatProperties(format).optimalTilingFeatures &
