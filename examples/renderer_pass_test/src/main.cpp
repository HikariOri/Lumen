...
int main() {
    ...
    windowConfig.title = "renderer_pass_test";
    ...
    auto context = *vulkan::Context::create(
        "renderer_pass_test", VK_MAKE_API_VERSION(0, 1, 0, 0),
    ...
    const auto vertexSpirv =
        load_spirv("./shaders/renderer_pass_test.vert.spv");
    const auto fragmentSpirv =
        load_spirv("./shaders/renderer_pass_test.frag.spv");
    ...
    // 描述符：set0=FrameUBO，set1=ObjectUBO（与 renderer_pass_test.vert 一致）
