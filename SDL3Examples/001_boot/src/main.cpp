...
int device_initialization(Init &init) {
    ...
    if (!phys_device_ret) {
        ...
        if (phys_device_ret.error() ==
            ...
            // const auto &detailed_reasons =
            //     phys_device_ret.detailed_failure_reasons();
...
int create_graphics_pipeline(Init &init, RenderData &data) {
    auto vert_code = readFile("./example/shaders/triangle.vert.spv");
    auto frag_code = readFile("./example/shaders/triangle.frag.spv");
